      ...
      <main className="page-container page-wide release-page">
        <section className="release-hero">
          ...
          <div className="hero-stats">
            <span className="hero-stat"><strong>AUC 0.927</strong> DevScore (n=110)</span>
            <span className="hero-stat-divider" aria-hidden="true">·</span>
            <span className="hero-stat"><strong>Cohen&rsquo;s d 1.62</strong> very large</span>
            <span className="hero-stat-divider" aria-hidden="true">·</span>
            <span className="hero-stat"><strong>p &lt; 10<sup>&minus;14</sup></strong> Mann-Whitney</span>
            <span className="hero-stat-divider" aria-hidden="true">·</span>
